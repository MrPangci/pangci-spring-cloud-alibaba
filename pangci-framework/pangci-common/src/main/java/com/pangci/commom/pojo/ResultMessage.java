...
import com.pangci.commom.exception.ErrorCode;
import com.pangci.commom.exception.ServiceException;
import com.pangci.commom.exception.enums.GlobalErrorCodeConstants;
...
public class ResultMessage<T> implements Serializable {
     ...
     */
    public static <T> ResultMessage<T> error(ResultMessage<?> result) {
    ...
    public static <T> ResultMessage<T> error(ErrorCode errorCode, Object... params) {
    ...
    public static <T> ResultMessage<T> error(ErrorCode errorCode) {
    ...
    public static <T> ResultMessage<T> error(ServiceException serviceException) {
